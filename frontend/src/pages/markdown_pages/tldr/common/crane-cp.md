...
name: crane-cp
path: /freedevtools/tldr/common/crane-cp
canonical: "https://hexmos.com/freedevtools/tldr/common/crane-cp/"
...
keywords:
- crane copy file
- crane copy directory
- crane file transfer
- crane cp linux
- crane cp macos
- crane cp windows
- crane container copy
- crane copy remote
- container file copy
- crane image copy
features:
...
- Transfer files to and from container images
- Mirror entire directory structures
- Simplifies file transfer workflows
