...
category: osx
keywords:
- directory removal macos
- folder deletion macos
- rmdir alternative macos
- command line directory delete
- grmdir command macos
- macos terminal commands
- empty directory removal
- delete directory osx
- remove folder command line
- macos folder management
features:
- Remove empty directories
- Alias for GNU rmdir
- Command-line interface
- Streamlined directory deletion
- macOS compatible
