...
keywords:
  ...
  - linux bug report tool
  - apport-bug command
  - ubuntu system reporting
  - linux command line reporting
  - terminal bug reporting
  - ubuntu debugging
  - linux error reporting
  - system error reporting ubuntu
  - apport bug submission
features:
  - Generates detailed bug reports.
  - Simplifies the bug reporting process.
