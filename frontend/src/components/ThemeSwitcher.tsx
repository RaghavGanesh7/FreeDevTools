  ...
  return (
    <div className="grid grid-cols-1 max-sm:hidden">
      <div className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full bg-gray-950/5 p-0.75 text-gray-950 dark:bg-white/10 dark:text-white">
        {/* System Theme */}
        <div
          className={`relative rounded-full p-1.5 *:size-7 cursor-pointer transition-all duration-200 ${theme === 'system'
        ...
        {/* Light Theme */}
        <div
          className={`relative rounded-full p-1.5 *:size-7 cursor-pointer transition-all duration-200 ${theme === 'light'
            ? 'bg-white ring ring-gray-950/10 dark:bg-gray-600 dark:ring-white/10'
            : 'hover:bg-gray-100 dark:hover:bg-gray-700'
            } sm:p-0`}
        ...
        {/* Dark Theme */}
        <div
          className={`relative rounded-full p-1.5 *:size-7 cursor-pointer transition-all duration-200 ${theme === 'dark'
            ? 'bg-white ring ring-gray-950/10 dark:bg-gray-600 dark:ring-white/10'
            : 'hover:bg-gray-100 dark:hover:bg-gray-700'
            } sm:p-0`}
