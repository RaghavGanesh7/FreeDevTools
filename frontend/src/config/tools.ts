...
export const TOOLS_CONFIG: Record<string, Tool> = {
  ...
  'og-meta-generator': {
    title:
      'Open Graph Meta Tag Generator - Create OG & Twitter Meta Tags | Online Free DevTools by Hexmos',
    name: 'Og Meta Generator',
    path: '/freedevtools/t/og-meta-generator/',
    description:
      'Generate Open Graph and Twitter meta tags instantly with Og Meta Generator by Hexmos. Customize page type, title, description, image, and more for perfect social sharing and SEO.',
    category: 'Developer Tools',
    icon: '🔖',
    themeColor: '#3b82f6',
  ...
  'yaml-to-toml': {
    title:
      'YAML to TOML Converter - Transform YAML to TOML Online | Free DevTools by Hexmos',
    name: 'YAML to TOML Converter',
    path: '/freedevtools/t/yaml-to-toml/',
    description:
      'Convert YAML to TOML format instantly with YAML to TOML Converter by Hexmos. Paste your YAML and get valid TOML output for configuration files, development, and deployment.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
  ...
  'svg-placeholder-generator': {
    title:
      'SVG Placeholder Generator - Create Custom SVG Placeholders Online | Free DevTools by Hexmos',
    name: 'SVG Placeholder Generator',
    path: '/freedevtools/t/svg-placeholder-generator/',
    description:
      'Generate custom SVG placeholder images instantly with SVG Placeholder Generator by Hexmos. Set width, height, background, text color, font size, and custom text for responsive design and rapid prototyping.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
  ...
  'rsa-key-pair-generator': {
    title:
      'RSA Key Pair Generator - Securely Generate RSA Keys | Online Free DevTools by Hexmos',
    name: 'RSA Key Pair Generator',
    path: '/freedevtools/t/rsa-key-pair-generator/',
    description:
      'Generate secure RSA public and private key pairs for encryption, decryption, and digital signatures. Choose your key size and generate keys instantly in your browser.',
    category: 'Security Tools',
    icon: '🔐',
    themeColor: '#3b82f6',
  ...
  'markdown-to-html-converter': {
    title:
      'Markdown to HTML Converter - Convert Markdown to HTML | Online Free DevTools by Hexmos',
    name: 'Markdown to HTML Converter',
    path: '/freedevtools/t/markdown-to-html-converter/',
    description:
      'Convert Markdown to HTML instantly with this free online tool. See the rendered HTML in real-time as you type.',
    category: 'Developer Tools',
    icon: '✍️',
    themeColor: '#3b82f6',
  ...
  'html-to-markdown': {
    title:
      'HTML to Markdown Converter - Convert HTML to Markdown | Online Free DevTools by Hexmos',
    name: 'HTML to Markdown Converter',
    path: '/freedevtools/t/html-to-markdown/',
    description:
      'Convert HTML to Markdown instantly with this free online tool. See the converted Markdown in real-time as you type.',
    category: 'Developer Tools',
    icon: '✍️',
    themeColor: '#3b82f6',
    ...
    ogImage:
      'https://hexmos.com/freedevtools/tool-banners/html-to-markdown-banner.png',
    twitterImage:
      'https://hexmos.com/freedevtools/tool-banners/html-to-markdown-banner.png',
    datePublished: '2025-09-22',
    softwareVersion: '1.0.0',
  ...
  'xml-to-json': {
    ...
    description:
      'Easily convert XML data to JSON format with our free online XML to JSON Converter. Fast, secure, and accurate conversion for developers and data analysts. No installation required.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
  ...
  'json-to-xml': {
    ...
    description:
      'Convert JSON data to XML format instantly with our free online JSON to XML Converter. Fast, secure, and accurate conversion for developers and data analysts. No installation required.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
  ...
  'zstd-compress': {
    title:
      'Zstandard (zstd) Compressor - Compress Files Online | Free DevTools by Hexmos',
    name: 'Zstandard Compressor',
    path: '/freedevtools/t/zstd-compress/',
    description:
      'Compress files using Zstandard (zstd) algorithm with our free online Zstd Compressor. Fast, efficient, and secure file compression for developers and users. No installation required.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
    ...
    ogImage:
      'https://hexmos.com/freedevtools/tool-banners/zstd-compress-banner.png',
    twitterImage:
      'https://hexmos.com/freedevtools/tool-banners/zstd-compress-banner.png',
    datePublished: '2025-09-23',
  },
  'zstd-decompress': {
    title:
      'Zstandard (zstd) Decompressor - Decompress Files Online | Free DevTools by Hexmos',
    name: 'Zstandard Decompressor',
    path: '/freedevtools/t/zstd-decompress/',
    description:
      'Decompress files using Zstandard (zstd) algorithm with our free online Zstd Decompressor. Fast, efficient, and secure file decompression for developers and users. No installation required.',
    category: 'Developer Tools',
    icon: '🛠️',
    themeColor: '#3b82f6',
